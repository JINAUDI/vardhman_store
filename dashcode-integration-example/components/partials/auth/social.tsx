...
const Social = ({ locale: _locale }: { locale: string }) => {
  return (
    <>
      <ul className="flex">
        <li className="flex-1">
        ...
        <li className="flex-1">
          <button type="button" className="inline-flex h-10 w-10 p-2 bg-[#EA4335] text-white text-2xl flex-col items-center justify-center rounded-full">
